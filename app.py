...
if contagem:
    ...
    fig, ax = plt.subplots(figsize=(2.2, 1.2))  # pequeno
...
# LOOP ORIGINAL CONTINUA EXATAMENTE IGUAL DAQUI PARA BAIXO
for i in range(len(dias)-1, 0, -1):
    ...
    # (todo seu restante permanece idêntico)